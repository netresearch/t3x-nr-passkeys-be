...
final class AdoptionStatsTest extends TestCase
{
    ...
    public function constructorSetsProperties(): void
    {
        ...
        $stats = new AdoptionStats(totalUsers: 100, usersWithPasskeys: 75, groups: [$group], usersWithoutPasskeys: [$user]);
    ...
    {
        $stats = new AdoptionStats(totalUsers: 200, usersWithPasskeys: 150, groups: [], usersWithoutPasskeys: []);
    ...
    {
        $stats = new AdoptionStats(totalUsers: 3, usersWithPasskeys: 1, groups: [], usersWithoutPasskeys: []);
    ...
    {
        $stats = new AdoptionStats(totalUsers: 50, usersWithPasskeys: 50, groups: [], usersWithoutPasskeys: []);
