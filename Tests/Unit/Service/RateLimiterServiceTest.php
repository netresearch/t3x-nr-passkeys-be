...
final class RateLimiterServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new RateLimiterService($this->rateLimitCacheMock, $this->configService, $this->lockFactoryMock, $this->loggerMock);
    }
    ...
    public function checkRateLimitPassesWhenNoPreviousAttempts(): void
    {
        ...
        $this->rateLimitCacheMock->method('get')->willReturn(false);
    ...
    public function checkRateLimitThrowsWhenOverLimit(): void
    {
        ...
        $this->rateLimitCacheMock->method('get')->willReturn('10');
        $this->expectException(RuntimeException::class);
        $this->expectExceptionCode(1700000010);
    ...
    {
        // Previous count is 3
        $this->rateLimitCacheMock->method('get')->willReturn('3');
        $this->rateLimitCacheMock
            ->expects(self::once())
            ->method('set')
    ...
    public function checkLockoutPassesUnderThreshold(): void
    {
        ...
        $this->rateLimitCacheMock->method('get')->willReturn('1');
    ...
    public function checkLockoutThrowsWhenPerUserThresholdExceeded(): void
    {
        ...
        $this->rateLimitCacheMock->method('get')->willReturnCallback(
            static function (string $key) use ($ipKey, $userKey): string|false {
                if ($key === $ipKey) {
                    return '2';
                }
    ...
    public function resetLockoutClearsCacheWithIp(): void
    {
        ...
        $this->rateLimitCacheMock->expects(self::never())->method('flushByTag');
    ...
    public function resetLockoutFlushesTagWithoutIp(): void
    {
        ...
        $this->rateLimitCacheMock->expects(self::never())->method('remove');
    ...
    public function lockoutKeyUsesHash(): void
    {
        ...
        $this->rateLimitCacheMock
            ...
            ->method('set')
            ->willReturnCallback(
                static function (string $key) use (&$setCalls): void {
                    $setCalls[] = $key;
                },
            );
    ...
    public function recordSuccessClearsCorrectKeys(): void
    {
        ...
        $this->rateLimitCacheMock
            ...
            ->method('remove')
            ->willReturnCallback(
                static function (string $key) use (&$removedKeys): bool {
                    $removedKeys[] = $key;
    ...
    public function checkRateLimitAcquiresAndReleasesLock(): void
    {
        ...
        $this->lockerMock
            ...
            ->method('acquire')
            ->willReturn(true);
        $this->lockerMock->expects(self::atLeastOnce())->method('release');
        $this->subject->checkRateLimit('register', '192.168.1.1');
    }
    ...
    public function recordAttemptAcquiresAndReleasesLock(): void
    {
        ...
        $this->lockerMock
            ...
            ->willReturn(true);
        $this->lockerMock->expects(self::atLeastOnce())->method('release');
        $this->rateLimitCacheMock->expects(self::once())->method('set');
        $this->subject->recordAttempt('register', '192.168.1.1');
    }
    ...
    {
        $this->rateLimitCacheMock->method('get')->willReturn(false);
        $this->rateLimitCacheMock->method('set')->willThrowException(new RuntimeException('Cache write failed'));
