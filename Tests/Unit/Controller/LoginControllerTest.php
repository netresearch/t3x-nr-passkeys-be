...
final class LoginControllerTest extends TestCase
{
    ...
    public function optionsActionWithValidUsername(): void
    {
        ...
        $this->webAuthnService
            ...
            ->with('admin', 42)
            ->willReturn(
                new AssertionOptions(options: $options, challengeToken: 'ct_abc123'),
            );
        $this->webAuthnService
            ->expects(self::once())
            ...
            ->with($options)
            ->willReturn(
                '{"challenge":"abc","rpId":"example.com"}',
            );
    ...
    {
        $budgetNs = 150000000.0;
        self::assertGreaterThan($budgetNs * 0.9, $elapsedNs, 'Response must not come back before the budget');
        self::assertLessThan(2000000000.0, $elapsedNs, 'Response must not sleep far beyond the budget');
    }
    ...
    private function stubAssertionOptionGeneration(): void
    {
        ...
        $this->webAuthnService
            ->method('createAssertionOptions')
            ->willReturn(
                new AssertionOptions(options: $options, challengeToken: 'ct_known'),
            );
        $this->webAuthnService
            ->method('createDecoyAssertionOptions')
            ->willReturn(
                new AssertionOptions(options: $options, challengeToken: 'ct_decoy'),
            );
        $this->webAuthnService
            ->method('serializeRequestOptions')
            ->willReturn(
    ...
    public function optionsActionWithEmptyUsernameWhenDiscoverableEnabled(): void
    {
        ...
        $this->configService
            ->method('getConfiguration')
            ->willReturn(
                new ExtensionConfiguration(discoverableLoginEnabled: true),
            );
        ...
        $this->webAuthnService
            ...
            ->willReturn(
                new AssertionOptions(options: $options, challengeToken: 'ct_discoverable'),
            );
        $this->webAuthnService
            ->expects(self::once())
            ->method('serializeRequestOptions')
    ...
    public function optionsActionWithUnknownUserReturnsDecoyOptionsToPreventEnumeration(): void
    {
        ...
        $this->webAuthnService
            ...
            ->with($options)
            ->willReturn(
                '{"challenge":"abc","rpId":"example.com","allowCredentials":[{"type":"public-key","id":"decoy"}]}',
            );
        $response = $this->subject->optionsAction($request);
    ...
    public function optionsActionWhenRateLimited(): void
    {
        ...
        $this->rateLimiterService
            ...
            ->willThrowException(
                new RuntimeException('Rate limit exceeded', 1700000010),
            );
        $response = $this->subject->optionsAction($request);
    ...
    public function verifyActionMapsNonRuntimeExceptionsToTheGeneric401(): void
    {
        ...
        $this->webAuthnService
            ...
            ->method('verifyAssertionResponse')
            ->willThrowException(
                new InvalidDataException(null, 'Invalid input'),
            );
        $this->rateLimiterService
            ->expects(self::once())
            ->method('recordFailure')
    ...
    public function optionsActionDiscoverableLoginInternalError(): void
    {
        ...
        $this->logger
            ...
            ->method('error')
            ->with(
                'Failed to generate discoverable assertion options',
                self::anything(),
            );
        $response = $this->subject->optionsAction($request);
    ...
    public function optionsActionLockout(): void
    {
        ...
        $this->rateLimiterService
            ->method('checkLockout')
            ->willThrowException(
                new RuntimeException('Account locked out', 1700000011),
            );
        $response = $this->subject->optionsAction($request);
        self::assertSame(429, $response->getStatusCode());
        $body = $this->decodeResponse($response);
    ...
    {
        $request = $this->createJsonRequest(['username' => '', 'assertion' => '{"id":"cred123"}', 'challengeToken' => 'ct_abc123']);
        $response = $this->subject->verifyAction($request);
        self::assertSame(400, $response->getStatusCode());
        $body = $this->decodeResponse($response);
        self::assertSame('Missing required fields', $body['error']);
    ...
    {
        $request = $this->createJsonRequest(['username' => 'admin', 'assertion' => '', 'challengeToken' => 'ct_abc123']);
        $response = $this->subject->verifyAction($request);
        self::assertSame(400, $response->getStatusCode());
        $body = $this->decodeResponse($response);
        self::assertSame('Missing required fields', $body['error']);
    ...
    {
        $request = $this->createJsonRequest(['username' => 'admin', 'assertion' => '{"id":"cred123"}', 'challengeToken' => '']);
        $response = $this->subject->verifyAction($request);
        self::assertSame(400, $response->getStatusCode());
        $body = $this->decodeResponse($response);
        self::assertSame('Missing required fields', $body['error']);
    ...
    public function optionsActionConsumesRateLimit(): void
    {
        ...
        $this->webAuthnService
            ->method('createAssertionOptions')
            ->willReturn(
                new AssertionOptions(options: $options, challengeToken: 'ct'),
            );
        $this->webAuthnService
            ->method('serializeRequestOptions')
