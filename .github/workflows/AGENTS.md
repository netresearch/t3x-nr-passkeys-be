...
| `stan` | PHP 8.2-8.5 x TYPO3 12/13/14 | PHPStan level 10 |
| `unit` | PHP 8.2-8.5 x TYPO3 12/13/14 | Unit tests with coverage |
| `fuzz` | PHP 8.2-8.5 | Fuzz tests (no coverage) |
| `functional` | PHP 8.2-8.4 x TYPO3 12/13/14 | Functional tests with MySQL |
